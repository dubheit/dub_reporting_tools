...
OLD_MODULE_NAME = 'db_reporting_ilovepdf_documents'
NEW_MODULE_NAME = 'dub_reporting_ilovepdf_documents'


def pre_init_hook(env):
    """Migrate db_reporting_ilovepdf_documents to dub_reporting_ilovepdf_documents.
...
def post_init_hook(env):
    """Embed ILovePDF action on all existing folders after module installation."""
    _logger.info('Running post_init_hook for dub_reporting_ilovepdf_documents')
    env['documents.document']._embed_ilovepdf_action_on_all_folders()
